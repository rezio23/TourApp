...
public final class ItemFavoriteBinding implements ViewBinding {
  ...
  private ItemFavoriteBinding(@NonNull MaterialCardView rootView, @NonNull ImageButton btnRemove,
      @NonNull ImageView ivTourImage, @NonNull TextView tvAddress, @NonNull TextView tvPrice,
  ...
  public static ItemFavoriteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFavoriteBinding((MaterialCardView) rootView, btnRemove, ivTourImage, tvAddress,
